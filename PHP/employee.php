...
<form name="dropdown">
 ...
 <option value="employee.php">Please select one</option>
...
<br>
<div style="height:600px;width:1300px;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">
        <table border="1">
        <thead>
            <tr>
                <td><center>Employee Number<td><center></center>
        ...
        <?php
            ...
            $results = $conn->query("SELECT * FROM employee where not employeenumber='10'");
